...
try:
    ...
    if df_customers is not None and not df_customers.empty:
        ...
        # Upload to Azure
        blob_name = f"maxio/customers/customers_{run_time}.csv"
...
try:
    ...
    if df_transactions is not None and not df_transactions.empty:
        ...
        # Upload to Azure
        blob_name = f"maxio/transactions/transactions_{run_time}.csv"
...
try:
    ...
    if df_invoices is not None and not df_invoices.empty:
        ...
        # Upload to Azure
        blob_name = f"maxio/invoices/invoices_{run_time}.csv"
...
try:
    ...
    if df_payments is not None and not df_payments.empty:
        ...
        # Upload to Azure
        blob_name = f"maxio/payments/payments_{run_time}.csv"
...
try:
    ...
    if df_revenue_entries is not None and not df_revenue_entries.empty:
        ...
        # Upload to Azure
        blob_name = f"maxio/revenue_entries/revenue_entries_{run_time}.csv"
...
try:
    ...
    if df_reports is not None and not df_reports.empty:
        ...
        # Upload to Azure
        blob_name = f"maxio/reports/reports_{run_time}.csv"
...
try:
    ...
    if df_expenses is not None and not df_expenses.empty:
        ...
        # Upload to Azure
        blob_name = f"maxio/expenses/expenses_{run_time}.csv"
